<div class="container">
	...
	<div class="navbar-collapse collapse">
		...
		<li><a href="blogs" class="">Blogs</a></li> -->
			...
			<li><a style="cursor: pointer;"  data-toggle="modal"  data-backdrop="false" data-target="#squarespaceModalCityAndArea" ><span class="fa fa-map-marker"> <!-- fa-2x -->&nbsp;</span><b style="" class="myCityName"></b></a></li>
		</ul>
...
<ul class="wpb-mobile-menu">
	...
	<li><a href="contact" class="">Contact</a></li>
	<li><a style="cursor: pointer;"  data-toggle="modal"  data-backdrop="false" data-target="#squarespaceModalCityAndArea" ><span class="fa fa-map-marker ">&nbsp;</span><b style="" class="myCityName"></b></a></li>
</ul>