...
<div style="display: block;">
    <header class="masthead  text-white">
      <div class="masthead-content">
        ...
        <div class="row h-100">
          ...
          <h3 class=" text-center" style="margin-top: 16px;">Check Payment-Details</h3>
      	 ...
      	 <input type="text" id="merchantTxnId" name="merchantTxnId" value="<%=request.getAttribute("MerchantTxnId") %>" />
            <input type="text" id="currency" name="currency" value="<%=request.getAttribute("currency") %>" />
      <%--  <input type="hidden" id="orderAmount" name="orderAmount" value="<%=request.getAttribute("orderAmount") %>" />
       ...
       <input type="text" name="returnUrl" value="<%=request.getAttribute("returnURL") %>" />
       <input type="text" id="notifyUrl" name="notifyUrl" value="<%=request.getAttribute("returnURL") %>" />
       <input type="text" id="secSignature" name="secSignature" value="<%=request.getAttribute("secSignature") %>" />
