...
<title>OutGo | Home</title>
<link rel="icon" href="https://s3.ap-south-1.amazonaws.com/outgo-images/Logo/OutGo-SmartBiz.png" type="image/gif" sizes="16x16">
...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/assets/outgoAssets/asset/css/bootstrap.min.css"
	type="text/css" media="screen">

<link rel="stylesheet"
	href="<%=request.getContextPath()%>/assets/outgoAssets/css/settings.css"
	type="text/css" media="screen">

<link rel="stylesheet"
	href="<%=request.getContextPath()%>/assets/outgoAssets/css/font-awesome.min.css"
	type="text/css" media="screen">

<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/assets/outgoAssets/css/slicknav.css"
	media="screen">

<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/assets/outgoAssets/css/style.css"
	media="screen">

<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/assets/outgoAssets/css/responsive.css"
	media="screen">

<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/assets/outgoAssets/css/animate.css"
	media="screen">

<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/assets/outgoAssets/css/colors/red.css"
	media="screen" />
...
<link rel="alternate stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/assets/outgoAssets/css/colors/jade.css"
	title="jade" media="screen" />
<link rel="alternate stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/assets/outgoAssets/css/colors/green.css"
	title="green" media="screen" />
<link rel="alternate stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/assets/outgoAssets/css/colors/blue.css"
	title="blue" media="screen" />
<link rel="alternate stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/assets/outgoAssets/css/colors/beige.css"
	title="beige" media="screen" />
<link rel="alternate stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/assets/outgoAssets/css/colors/cyan.css"
	title="cyan" media="screen" />
<link rel="alternate stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/assets/outgoAssets/css/colors/orange.css"
	title="orange" media="screen" />
<link rel="alternate stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/assets/outgoAssets/css/colors/peach.css"
	title="peach" media="screen" />
<link rel="alternate stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/assets/outgoAssets/css/colors/pink.css"
	title="pink" media="screen" />
<link rel="alternate stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/assets/outgoAssets/css/colors/purple.css"
	title="purple" media="screen" />
<link rel="alternate stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/assets/outgoAssets/css/colors/sky-blue.css"
	title="sky-blue" media="screen" />
<link rel="alternate stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/assets/outgoAssets/css/colors/yellow.css"
	title="yellow" media="screen" />

<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/js/jquery-2.1.4.min.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/js/jquery.migrate.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/js/modernizrr.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/asset/js/bootstrap.min.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/js/jquery.fitvids.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/js/owl.carousel.min.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/js/nivo-lightbox.min.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/js/jquery.isotope.min.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/js/jquery.appear.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/js/count-to.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/js/jquery.textillate.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/js/jquery.lettering.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/js/jquery.easypiechart.min.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/js/smooth-scroll.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/js/skrollr.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/js/jquery.parallax.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/js/mediaelement-and-player.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/js/jquery.slicknav.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/js/style.changer.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/js/jquery.themepunch.revolution.min.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/outgoAssets/js/jquery.themepunch.tools.min.js"></script>
...
var $b={},ac=null;$b.A="UA-115397152-1";var bc=null,cc={},dc={};var ec=function(){},fc=function(a){return"function"==typeof a},gc=function(a){return"string"==oa(a)},hc=function(a){return"number"==oa(a)&&!isNaN(a)},ic=function(a){return Math.round(Number(a))||0},jc=function(a){return"false"==String(a).toLowerCase()?!1:!!a},kc=function(a){var b=[];if(ia(a))for(var c=0;c<a.length;c++)b.push(String(a[c]));return b},lc=function(a){return a?a.replace(/^\s+|\s+$/g,""):""},mc=function(a,b){if(!hc(a)||!hc(b)||a>b)a=0,b=2147483647;return Math.floor(Math.random()*(b-a+1)+
...
<body onload="javascript:chooseStyle('blue', 60)">
	...
	<div id="container"> <!-- parent container  -->
						...
						<div class="col-md-7">
							...
							<ul class="contact-details">
								<li><a href="#"><i class="fa fa-map-marker"></i>
										Shivajinagar, Pune</a></li>
								<li><a href="mailto:support@outgo.co" target="_blank"><i
										class=""></i> <span class="">support@outgo.co</span></a></li>
						...
						<div class="col-md-5">
							...
							<ul class="social-list">
								<li><a class="facebook itl-tooltip" data-placement="bottom"
									title="Facebook" href="https://www.facebook.com/OutgoPayments/"
									target="_blank"><i class="fa fa-facebook"></i></a></li>
								<li><a class="instgram itl-tooltip" data-placement="bottom"
									title="Instagram"
									href="https://www.instagram.com/outgopayments/" target="_blank"><i
										class="fa fa-instagram"></i></a>
								<li><a class="linkdin itl-tooltip" data-placement="bottom"
									title="Linkedin"
									href="https://www.linkedin.com/company/10783486/admin/updates/"
									target="_blank"><i class="fa fa-linkedin"></i></a></li>

								<li><a class="twitter itl-tooltip" data-placement="bottom"
									title="Twitter" href="https://twitter.com/OutgoPayments"
			...
			<div class="navbar navbar-default navbar-top" role="navigation"
				...
				<div class="container">
					...
					<div class="navbar-collapse collapse">
						...
						<!-- <li><a class="open-switcher hidden-xs show-switcher" style="font-family: sans-serif;font-size:medium;background-color: #00afd1; color: #fff;padding-top: 5px"><b>Enquiry</b></a>
								</li> -->
				...
				<ul class="wpb-mobile-menu">
					...
					<!-- 	<li><a href="#">Blog</a>
						...
						<li>
							<a 	href="http://smartbiz.outgo.co/login">For Merchant</a></li>
				...
				<div class="tp-banner">
					<ul>
						<li data-transition="zoomout" data-slotamount="7"
							...
							data-thumb="<%=request.getContextPath()%>/assets/outgoAssets/images/slider/bg1.jpg"
							data-rotate="0" data-saveperformance="off" data-title="Slide"
							data-description="on"><img
							src="<%=request.getContextPath()%>/assets/outgoAssets/images/dummy.png"
							alt="laptopmockup_sliderdy"
							data-lazyload="<%=request.getContextPath()%>/assets/outgoAssets/images/slider/bg1.jpg">

							<div class="tp-caption lfl start" data-x="-368" data-y="center"
								data-voffset="0" data-speed="1200" data-start="500"
								data-easing="easeInOutExpo" data-elementdelay="0.1"
								data-endelementd8elay="0.1" data-endspeed="300"
								style="z-index: 5; left: -160.045px; top: -122.5px; visibility: visible; opacity: 0; transform: translate3d(-925.364px, 0px, 0px);">
								<img style="width: 1116px; height: 695.455px;" 
									src="<%=request.getContextPath()%>/assets/outgoAssets/images/slider/01.png"
									alt="">
							</div>

							<div class="tp-caption lfb rs-parallaxlevel-3 start"
								data-x="right" data-hoffset="100" data-y="center"
								data-voffset="0" data-speed="1200" data-start="1200"
								data-easing="Power4.easeInOut" data-elementdelay="0.1"
								data-endelementdelay="0.1" data-endspeed="300"
								style="z-index: 5; left: 959.5px; top: 10px; visibility: visible; opacity: 0; transform: translate3d(1918px, 0px, 0px);">
								<img style="width: 612px; height: 730px;"
									src="<%=request.getContextPath()%>/assets/outgoAssets/images/slider/App_Using_Banner.png"
									alt="">
							</div>

							<div
								class="tp-caption largeHeading global-link-color customin customout tp-resizeme start"
								data-x="35" data-y="center" data-voffset="-130"
								...
								data-speed="1200" data-start="1300" data-easing="Back.easeInOut"
								data-splitin="none" data-splitout="none" data-elementdelay="0.1"
								data-endelementdelay="0.1" data-endspeed="400"
								data-endeasing="Back.easeIn">
								<h1 style="line-height: 73px; font-size: 61px;">WELCOME TO</h1>
							</div>

							<div
								class="tp-caption largeHeading customin customout tp-resizeme start"
								data-x="35" data-y="center" data-voffset="-45"
								data-customin="x:0;y:0;z:0;rotationX:90;rotationY:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:200;transformOrigin:50% 0%;"
								data-customout="x:0;y:0;z:0;rotationX:90;rotationY:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:200;transformOrigin:50% 0%;"
								data-speed="1200" data-start="1750" data-easing="Back.easeInOut"
								data-splitin="none" data-splitout="none" data-elementdelay="0.1"
								data-endelementdelay="0.1" data-endspeed="400"
								data-endeasing="Back.easeIn" style="z-index: 10;">
								<h1 style="font-size: 61px; color: white;">OutGo SmartBiz</h1>
							</div>

							<div class="tp-caption detailText p sfr tp-resizeme start"
								data-x="35" data-y="center" data-voffset="40" data-speed="1200"
								data-start="2100" data-easing="easeInOutExpo"
								data-splitin="none" data-splitout="none" data-elementdelay="0.1"
								data-endelementdelay="0.1" data-endspeed="300"
								style="z-index: 8;">
								<p style="font-size: 15px;" class="hidden-xs">
									Digitalize Your Business <br style="font-size: 12px;">
									&nbsp;<b style="color: #89c345">Go</b> <b
										style="color: #00afd1">Cashless,</b> <b style="color: #89c345">Go</b>
									<b style="color: #00afd1">Digital</b>
								</p>
							</div>

							<div class="tp-caption lfb tp-resizeme start divData" data-x="35"
								data-y="center" data-voffset="145" data-speed="1200"
								data-start="2500" data-easing="easeInOutExpo"
								data-splitin="none" data-splitout="none" data-elementdelay="0.1"
								data-endelementdelay="0.1" data-endspeed="300"
								style="z-index: 9;">
								<a class="slider btn btn-system btn-large btn-min-block" 
									href="http://smartbiz.outgo.co/login">Merchant</a>&nbsp;<!-- class to hidden is  btn-system  --> <a
									class="slider btn btn-system btn-large btn-min-block" href="user-home">User</a> <!-- class to hidden is  btn-system  -->
							</div></li>

						<li data-transition="zoomout" data-slotamount="7"
							data-easein="default" data-easeout="default"
							data-masterspeed="300"
							data-thumb="<%=request.getContextPath()%>/assets/outgoAssets/images/slider/bg5.png"
							data-rotate="0" data-saveperformance="off" data-title="Slide"
							data-description="on"><img
							src="<%=request.getContextPath()%>/assets/outgoAssets/images/dummy.png"
							alt="laptopmockup_sliderdy"
							data-lazyload="<%=request.getContextPath()%>/assets/outgoAssets/images/slider/bg5.png">
							...
							<div
								...
								data-endeasing="Back.easeIn">
								<h1
									style="line-height: 73px; font-size: 61px; text-shadow: 2px 2px #222;">SmartBiz</h1>
							</div>
							...
							<div
								...
								data-endeasing="Back.easeIn" style="z-index: 10;">
								<h1
									style="font-size: 51px; color: white; text-shadow: 2px 2px #222;">Manage
									customers &amp; tasks</h1>
							</div>

							<div class="tp-caption detailText p lfl tp-resizeme start"
								data-x="35" data-y="center" data-voffset="45" data-speed="1200"
								data-start="2100" data-easing="easeInOutExpo"
								data-splitin="none" data-splitout="none" data-elementdelay="0.1"
								data-endelementdelay="0.1" data-endspeed="300"
								style="z-index: 8;">
							...
							<div class="tp-caption lfb tp-resizeme start divData" data-x="35"
								...
								style="z-index: 9;">
								<a class="slider btn btn-system  btn-large btn-min-block"
									href="http://smartbiz.outgo.co/login">Merchant</a>&nbsp; <a
									class="slider btn btn-system btn-large btn-min-block" href="user-home">User</a>
							</div></li>
						<li data-transition="zoomout" data-slotamount="7"
							data-easein="default" data-easeout="default"
							data-masterspeed="300"
							data-thumb="<%=request.getContextPath()%>/assets/outgoAssets/images/slider/newPlan.jpg"
							data-rotate="0" data-saveperformance="off" data-title="Slide"
							data-description="on"><img
							src="<%=request.getContextPath()%>/assets/outgoAssets/images/dummy.png"
							alt="laptopmockup_sliderdy"
							data-lazyload="<%=request.getContextPath()%>/assets/outgoAssets/images/slider/newPlan.jpg">
							...
							<div class="tp-caption lfl start" data-x="-368" data-y="center"
								...
								style="z-index: 5; left: -160.045px; top: -122.5px; visibility: visible; opacity: 0; transform: translate3d(-925.364px, 0px, 0px);">
								<img style="width: 1116px; height: 695.455px;"
									src="<%=request.getContextPath()%>/assets/outgoAssets/images/slider/02.png"
									alt="">
							</div>
							...
							<div class="tp-caption lfb rs-parallaxlevel-3 start"
								...
								style="z-index: 5; left: 959.5px; top: 10px; visibility: visible; opacity: 0; transform: translate3d(1918px, 0px, 0px);">
								<!-- <img style="width: 612px; height: 730px;"
									src="images/slider/04.png" alt=""> -->
								<img style="width: 312px; height: 530px; margin-right:50px"
									src="<%=request.getContextPath()%>/assets/outgoAssets/images/slider/userdashboard.png"
									alt="">
							...
							<div
								...
								data-endelementdelay="0.1" data-endspeed="400"
								data-endeasing="Back.easeIn">
								<h1 style="line-height: 73px; font-size: 61px;">OutGo</h1>
							</div>
							...
							<div
								...
								data-endelementdelay="0.1" data-endspeed="400"
								data-endeasing="Back.easeIn" style="z-index: 10;">
								<h1 style="font-size: 61px; color: white;">SmartBiz</h1>
							</div>
		...
		<!-- 
		<div class="section service" id="Product">
			<div class="container">
				<div class="row">
				
				<div class="col-md-12 text-center" style="padding-top: 60px;padding-bottom: 10px">
				<h1 style="color:#00afd1">OUR PRODUCT</h1>
				</div>
				</div>
				<div class="row">
					<div class="col-md-3 col-sm-6 service-box service-center"
						...
						<div class="service-content">
							...
							<p>Duis aute irure dolor in reprehenderit in voluptate velit
								esse cillum dolore eu fugiat Lorem pariatur</p>
						</div>
					</div>


					<div class="col-md-3 col-sm-6 service-box service-center"
						data-animation="fadeIn" data-animation-delay="02">
						<div class="service-icon">
					...
					<div class="col-md-3 col-sm-6 service-box service-center"
						data-animation="fadeIn" data-animation-delay="03">
						<div class="service-icon">
					...
					<div class="col-md-3 col-sm-6 service-box service-center"
						data-animation="fadeIn" data-animation-delay="04">
						<div class="service-icon">
					...
					<div class="col-md-3 col-sm-6 service-box service-center"
						data-animation="fadeIn" data-animation-delay="05">
						<div class="service-icon">
					...
					<div class="col-md-3 col-sm-6 service-box service-center"
						data-animation="fadeIn" data-animation-delay="06">
						<div class="service-icon">
					...
					<div class="col-md-3 col-sm-6 service-box service-center"
						data-animation="fadeIn" data-animation-delay="07">
						<div class="service-icon">
					...
					<div class="col-md-3 col-sm-6 service-box service-center"
						data-animation="fadeIn" data-animation-delay="08">
						<div class="service-icon">
...
<div id="Feature" style="padding-bottom: 50px">
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center"
						style="padding-top: 60px; padding-bottom: 10px">
						<h2 style="color: #00afd1">FEATURES</h2>
					</div>
				</div>
				<div class="row">
					<div class="col-md-8">
						...
						<div class="latest-posts">
							<h4 class="classic-title">
								<span>Why You Should Use OutGo?</span>
							</h4>
							<div class="latest-posts-classic custom-carousel touch-carousel"
								...
								<div class="post-row item">
									...
									<h3 class="post-title">
										<a href="http://smartbiz.outgo.co/login">Merchant</a>
									</h3>
									<div class="post-content">
										<p>
											...
											deserunt mollit. <a class="read-more" href="#">Read
												More...</a> -->
											<br> - Invoicing/billing automation<br> - Online
											collection using app/portal/sms links<br> - Customers,
											Leads and Tasks managment<br> - Same day Onboarding and
											activation<br> - Low cost technology partnership
										</p>
									</div>
								</div>
								...
								<div class="post-row item">
									...
									<div class="post-content">
										<p>
											...
											deserunt mollit. <a class="read-more" href="#">Read
												More...</a> -->
											<br> - Free signup<br> - Safe and secure payments<br>
											- One stop for bill payments<br> - Expense management<br>
											- Discover and avail local services
										</p>
									</div>
								</div>
						...
						<div class="custom-carousel show-one-slide touch-carousel"
							...
							<div class="classic-testimonials item">
								<div class="testimonial-content">
									<p>I developed a software to run my business smoothly from
										Outgo. It was a great experience to work with Outgo people.
										The main thing is the people there are very co-operative. They
										helped me in continuous development of my software to make it
										more better. Work in time is the great thing the Outgo people
										follows.</p>
								</div>
								<div class="testimonial-author">

									<span>Amit Shivle</span> -(Malhar Broadband)
								</div>
							</div>

							<div class="classic-testimonials item">
								<div class="testimonial-content">
									<p>OutGo made us shift from manual payment collection to
										online payment collection within three days and with zero
										setup cost. The experience has been very good..</p>
								</div>
								<div class="testimonial-author">
									<span>Kishor Kalate </span> - (Linkup Broadband)
							...
							<div class="classic-testimonials item">
								<div class="testimonial-content">
									<p>I received a very customized service from Outgo. Very
										supportive team and efficient in technology delivery. I
										recommend this team for your portal and payment collection
										process. They are very reasonable too. You won't get such a
										service even from an international company. Thanks Outgo.</p>
								</div>
								<div class="testimonial-author">
									<span>Sujeet Bhosale</span> - (Lionsleaf Broadband &amp;
		...
		<div id="parallax" data-stellar-background-ratio="0.5"
			class="parallax"
			style="background-image: url(<%=request.getContextPath()%>/assets/outgoAssets/images/parallax/bg-01.jpg);">
					...
					<div class="container">
						<div class="row">
							...
							<div class="section-video-content text-center">
								...
								<h2 class="fittext wite-text uppercase tlt">
									<span class="texts"> <span> Invoicing and
											collection platform</span> <span>Automate communication with
											consumers</span> <span>Manage customers and tasks better</span>
									</span>
									<!--   <br /> <strong>     </strong> -->
								...
								<!-- <a href="#" class="btn-system btn-large"><i
									class="fa fa-tasks"></i> Check Out Features</a> <a href="#"
									class="btn-system btn-large btn-wite"><i
									class="fa fa-download"></i> Purchase This Now</a> -->
							</div>
		...
		<!-- <div class="section full-width-portfolio"
			...
			<ul id="portfolio-list" data-animated="fadeIn">
				<li><img src="images/portfolio-1/1.jpg" alt="" />
					<div class="portfolio-item-content">
						<span class="header">Town winter 2016</span>
						<p class="body animated8">web develpment, design</p>
					</div>
					<div class="icon-list">
						<a class="link" href="single-project.html"><i
							class="fa fa-link"></i></a> <a class="zoom lightbox"
							href="images/portfolio-1/1.jpg"><i class="fa fa-search-plus"></i></a>
					</div></li>
				<li><img src="images/portfolio-1/2.jpg" alt="" />
					<div class="portfolio-item-content">
					...
					<div class="icon-list">
						<a class="link" href="single-project.html"><i
							class="fa fa-link"></i></a> <a class="zoom lightbox"
							href="images/portfolio-1/2.jpg"><i class="fa fa-search-plus"></i></a>
					</div></li>
				<li><img src="images/portfolio-1/3.jpg" alt="" />
					<div class="portfolio-item-content">
					...
					<div class="icon-list">
						<a class="link" href="single-project.html"><i
							class="fa fa-link"></i></a> <a class="zoom lightbox"
							href="images/portfolio-1/3.jpg"><i class="fa fa-search-plus"></i></a>
					</div></li>
				<li><img src="images/portfolio-1/4.jpg" alt="" />
					<div class="portfolio-item-content">
					...
					<div class="icon-list">
						<a class="link" href="single-project.html"><i
							class="fa fa-link"></i></a> <a class="zoom lightbox"
							href="images/portfolio-1/4.jpg"><i class="fa fa-search-plus"></i></a>
					</div></li>
				<li><img src="images/portfolio-1/5.jpg" alt="" />
					<div class="portfolio-item-content">
					...
					<div class="icon-list">
						<a class="link" href="single-project.html"><i
							class="fa fa-link"></i></a> <a class="zoom lightbox"
							href="images/portfolio-1/5.jpg"><i class="fa fa-search-plus"></i></a>
					</div></li>
				<li><img src="images/portfolio-1/6.jpg" alt="" />
					<div class="portfolio-item-content">
					...
					<div class="icon-list">
						<a class="link" href="single-project.html"><i
							class="fa fa-link"></i></a> <a class="zoom lightbox"
							href="images/portfolio-1/6.jpg"><i class="fa fa-search-plus"></i></a>
					</div></li>
				<li><img src="images/portfolio-1/7.jpg" alt="" />
					<div class="portfolio-item-content">
						<span class="header">Monocle issue 69</span>
						<p class="body">web develpment, design</p>
					</div>
					<div class="icon-list">
						<a class="link" href="single-project.html"><i
							class="fa fa-link"></i></a> <a class="zoom lightbox"
							href="images/portfolio-1/7.jpg"><i class="fa fa-search-plus"></i></a>
					</div></li>
				<li><img src="images/portfolio-1/8.jpg" alt="" />
					<div class="portfolio-item-content">
						<span class="header">Monocle issue 69</span>
						<p class="body">web develpment, design</p>
					</div>
					<div class="icon-list">
						<a class="link" href="single-project.html"><i
							class="fa fa-link"></i></a> <a class="zoom lightbox"
							href="images/portfolio-1/8.jpg"><i class="fa fa-search-plus"></i></a>
					</div></li>
				<li><img src="images/portfolio-1/9.jpg" alt="" />
					<div class="portfolio-item-content">
						<span class="header">Monocle issue 69</span>
						<p class="body">web develpment, design</p>
					</div>
					<div class="icon-list">
						<a class="link" href="single-project.html"><i
							class="fa fa-link"></i></a> <a class="zoom lightbox"
							href="images/portfolio-1/9.jpg"><i class="fa fa-search-plus"></i></a>
					</div></li>
				<li><img src="images/portfolio-1/10.jpg" alt="" />
					<div class="portfolio-item-content">
						<span class="header">Monocle issue 69</span>
						<p class="body">web develpment, design</p>
					</div>
					<div class="icon-list">
						<a class="link" href="single-project.html"><i
							class="fa fa-link"></i></a> <a class="zoom lightbox"
							href="images/portfolio-1/10.jpg"><i class="fa fa-search-plus"></i></a>
					</div></li>
				<li><img src="images/portfolio-1/11.jpg" alt="" />
					<div class="portfolio-item-content">
						<span class="header">Monocle issue 69</span>
						<p class="body">web develpment, design</p>
					</div>
					<div class="icon-list">
						<a class="link" href="single-project.html"><i
							class="fa fa-link"></i></a> <a class="zoom lightbox"
							href="images/portfolio-1/11.jpg"><i class="fa fa-search-plus"></i></a>
					</div></li>
				<li><img src="images/portfolio-1/12.jpg" alt="" />
					<div class="portfolio-item-content">
						<span class="header">Monocle issue 69</span>
						<p class="body">web develpment, design</p>
					</div>
					<div class="icon-list">
						<a class="link" href="single-project.html"><i
							class="fa fa-link"></i></a> <a class="zoom lightbox"
							href="images/portfolio-1/12.jpg"><i class="fa fa-search-plus"></i></a>
					</div></li>
			</ul>
		...
		<!-- 		<div class="section" style="background: #fff;">
			<div class="container">
				...
				<p class="text-center">
					Sed ut perspiciatis unde omnis iste natus error sit voluptatem
					accusantium <span class="accent-color sh-tooltip"
						data-placement="right" title="Simple Tooltip">doloremque
						laudantium</span>, totam rem aperiam, eaque ipsa quae ab illo inventore <br />veritatis
					et quasi <span class="accent-color sh-tooltip"
						data-placement="bottom" title="Simple Tooltip">architecto</span>
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-6 col-xs-12" data-animation="fadeIn"
						...
						<div class="team-member modern">
							...
							<div class="member-info">
								<p>Duis aute irure dolor in reprehenderit in voluptate velit
									esse cillum dolore fugiat.</p>
							</div>

							<div class="progress-label">Photoshop</div>
							<div class="progress">
								<div class="progress-bar progress-bar-primary"
									data-progress-animation="96%" data-appear-animation-delay="400">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-primary"
									data-progress-animation="88%" data-appear-animation-delay="800">
							...
							<div class="member-socail">
								<a class="twitter" href="#"><i class="fa fa-twitter"></i></a> <a
									class="gplus" href="#"><i class="fa fa-google-plus"></i></a> <a
									class="linkedin" href="#"><i class="fa fa-linkedin"></i></a> <a
									class="flickr" href="#"><i class="fa fa-flickr"></i></a> <a
									class="mail" href="#"><i class="fa fa-envelope"></i></a>
							</div>
						</div>
					</div>
					...
					<div class="col-md-3 col-sm-6 col-xs-12" data-animation="fadeIn"
						...
						<div class="team-member modern">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-primary"
									data-progress-animation="94%" data-appear-animation-delay="800">
					...
					<div class="col-md-3 col-sm-6 col-xs-12" data-animation="fadeIn"
						...
						<div class="team-member modern">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-primary"
									data-progress-animation="85%" data-appear-animation-delay="800">
		...
		<div id="" class="container" style="padding-bottom: 30px">
		<div class="row">
					<div class="col-md-12 text-center"
						style="padding-top: 00px; padding-bottom: 10px">
						<h2 style="color: #00afd1; font-size: 24px; line-height: 30px;">SERVICES</h2>
					</div>
				</div>
			<div class="row">		
				...
				<div class="recent-projects">
					<h4 class="title">
						<span style="padding-left: 5px">Services To Pay  </span>
					</h4>
				...
				<div class="row">
					<div class="col-md-6 col-sm-12 col-xs-12">
						<div class="su-content-wrap">
							...
							<div class="col-md-6 col-sm-6 col-xs-12 animated fadeIn delay-01"
								data-animation="fadeIn" data-animation-delay="01">
								<div class="support-list-item">
									...
									<div class="icon-description text-center">
										...
										<!-- 	<p>Lorem Ipsum is simply dummy text of the printing and
											typesetting industry. It has survived not duic</p> -->
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-12 animated fadeIn delay-01"
								...
								<div class="support-list-item">
									<div class="icon-wrapper text-center">
										<i class="fa fa-inr icon-large"></i>
									</div>
									<div class="icon-description text-center">
							...
							<div class="col-md-6 col-sm-6 col-xs-12 animated fadeIn delay-01"
								...
								<div class="support-list-item">
									<div class="icon-wrapper text-center">
										<i class="fa fa-tasks icon-large"></i>
									</div>
									<div class="icon-description text-center">
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						<img
							src="<%=request.getContextPath()%>/assets/outgoAssets/images/03.jpg"
							alt="">
					</div>
				</div>
			</div>
		</div>
		<!-- <div id="parallax-one" data-stellar-background-ratio="0.5"
			class="parallax"
			style="background-image: url(images/parallax/bg-02.jpg);">
			<div class="parallax-text-container-1">
				<div class="parallax-text-item">
					<div class="container">
						<div class="row">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="big-title text-center">
							<h2 style="color: #00afd1">
								<!-- We Have Nice Pricing Plans For <strong>You!</strong> -->
								Plans that fits your needs
							</h2>
						</div>


						<!-- <p class="text-center">Sed ut perspiciatis unde omnis iste
					...
					<div class="col-md-3 col-sm-3 col-xs-12">
						<div class="pricing-table">
							...
							<div class="plan-price">
								...
								<div class="interval">Days</div>
							</div>
							<div class="plan-list">
								<ul>
									<li><strong>15</strong> Days Trial</li>
									<li><strong>Single</strong> commercial license</li>
									<li><strong>Partial</strong> functionality available</li>
									<li><strong>Limited</strong> technical support</li>
									<li><strong>100</strong> SMS Included</li>
									<li><strong>-</strong></li>
								</ul>
							</div>
							<div class="plan-signup">
								<a href="http://smartbiz.outgo.co/login"
									class="btn-system btn-small">Purchase</a>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-3 col-xs-12">
						<div class="pricing-table highlight-plan">
							...
							<div class="plan-list">
								<ul>
									<li><strong>Professional</strong> usage</li>
									<li><strong> Software as a Service (SaaS)</strong></li>
									<li><strong>Full functionality</strong> available</li>
									<li><strong> Technical</strong> Support</li>
									<li><strong>2000 SMS</strong> included yearly</li>
									<li><strong>-</strong></li>
								</ul>
							</div>
							<div class="plan-signup">
								<a href="http://smartbiz.outgo.co/login"
									class="btn-system btn-small border-btn">Purchase</a>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-3 col-xs-12">
						<div class="pricing-table">
							...
							<div class="plan-list">
								<ul>
									...
									<li><strong> Technical</strong> Support</li>
									<li><strong>2000 SMS</strong> included yearly</li>
									<li><strong>* Domain &amp; hosting included</strong></li>
								</ul>
							</div>
							<div class="plan-signup">
								<a href="http://smartbiz.outgo.co/login"
					...
					<div class="col-md-3 col-sm-3 col-xs-12">
						<div class="pricing-table">
							...
							<div class="plan-price">
								...
								<div class="interval">Transaction</div>
							</div>
							<div class="plan-list">
								<ul>
									<li><strong>Professional</strong> usage</li>
									<li><strong>Per Transaction</strong> model</li>
									<li><strong>Full functionality </strong> available</li>
									<li><strong> Technical</strong> Support</li>
									<li><strong> 100 SMS</strong> included</li>
									<li><strong>-</strong></li>
								</ul>
							</div>
							<div class="plan-signup">
			...
			<div class="container">
				<div class="row">
					...
					<div class="our-clients">
						<div
							class="clients-carousel custom-carousel touch-carousel navigation-3"
							data-appeared-items="5" data-navigation="true">

							<div class="client-item item">
								<a href="#"><img style="height: 70px"
									src="https://s3.ap-south-1.amazonaws.com/profile-merchant-logo/1936.png"
									alt="Astekar" /></a>
							</div>
							<div class="client-item item">
								<a href="#"><img style="height: 70px"
									src="https://s3.ap-south-1.amazonaws.com/lokbiradari.outgo.co/RoadMaster.jpg"
									alt="Road Master" /></a>
							</div>
							<div class="client-item item">
								<a href="#"><img style="height: 70px"
									src="https://s3.ap-south-1.amazonaws.com/lokbiradari.outgo.co/logo.jpg"
									alt="Lok Biradari Mitramandal" /></a>
							</div>

							<div class="client-item item">
								<a href="#"><img style="height: 70px"
									src="https://s3.ap-south-1.amazonaws.com/www.hi5group.com/resource/assets/img/test1.png"
									alt="Hi5" /></a>
							</div>

							<div class="client-item item">
								<a href="#"><img style="height: 70px"
									src="https://s3.ap-south-1.amazonaws.com/pay.outgo.co/c_logo.png"
									alt="Pune Central CPE Study Circle of WIRC of ICAI" /></a>
							</div>

							<!-- <div class="client-item item">
								<a href="#"><img style="height: 70px"
									src="http://lionsleaf.in/lionsLeafPG/newImg/LBTG_logo_18-08-2015.png"
									alt="LBTG" /></a>
							</div> -->

							<div class="client-item item">
								<a href="#"><img style="height: 70px"
									src="https://s3.ap-south-1.amazonaws.com/www.linkupbroadband.co.in/img/logo2.png"
									alt="Linkup Broadband" /></a>
							</div>

							<div class="client-item item">
								<a href="#"><img style="height: 70px"
									src="https://s3.ap-south-1.amazonaws.com/www.ctnl.in/img/ctnlLogo.png"
									alt="CTNL" /></a>
							</div>
			...
			<div class="container">
				<div class="row footer-widgets">
					...
					<div class="col-md-3 col-xs-12">
						<div class="footer-widget mail-subscribe-widget">
							<h4>
								Important Links !<span class="head-line"></span>
							</h4>
							<p>
								<a href="about-us">&diams; About us</a>
							</p>
							<p>
								<a href="services">&diams; Service</a>
							</p>
							<!-- <p> 
							<a href="#">&diams; Feature</a>
							</p> -->
							<p>
								<a href="contact">&diams; Contact</a>
							</p>
					...
					<div class="col-md-3 col-xs-12">
						<!-- <div class="footer-widget twitter-widget">
							<h4>
								Services<span class="head-line"></span>
							</h4>
							<ul>
								<li>
									<p>
						...
						<div class="footer-widget social-widget">
							...
							<ul class="social-icons">
								<li><a class="facebook"
									href="https://www.facebook.com/OutgoPayments/" target="_blank"><i
										class="fa fa-facebook"></i></a></li>
								<li><a class="twitter"
									href="https://twitter.com/OutgoPayments" target="_blank"><i
								...
								<li><a class="linkdin"
									href="https://www.linkedin.com/company/10783486/admin/updates/"
									target="_blank"><i class="fa fa-linkedin"></i></a></li>
								<!-- <li><a class="flickr" href="#"><i class="fa fa-flickr"></i></a>
								</li> -->
								<!-- <li><a class="tumblr" href="#"><i class="fa fa-tumblr"></i></a>
								</li> -->
								<li><a class="instgram"
									href="https://www.instagram.com/outgopayments/" target="_blank"><i
								...
								<!-- <li><a class="skype" href="#"><i class="fa fa-skype"></i></a> 
								</li>-->
							</ul>
						</div>
					</div>
					...
					<div class="col-md-3 col-xs-12">
						<div class="footer-widget flickr-widget">
							<h4>
								Legal<span class="head-line"></span>
							</h4>
							<p>
								<a href="terms">&diams; Terms &amp; Conditions</a>
							</p>
						</div>
					</div>
					...
					<div class="col-md-3 col-xs-12">
						<div class="footer-widget contact-widget">
							<h4>
								<img
									src="<%=request.getContextPath()%>/assets/outgoAssets/images/footer-logo.png"
									class="img-responsive" alt="Footer Logo" />
							</h4>
							<!-- <p>We help businesses to automate their billing and
								collection, help them grow and communicate better with their
								consumers by empowering them with app/portal/APIs/QR code</p> -->
							<ul>
								<li><span>Phone Number:</span> +91 7083083646</li>
								<li><span>Email:</span> <a href="#">support@outgo.co</a></li>
								<li><span>Website:</span><a
									href="https://www.outgo.co/index" target="_blank">www.outgo.co</a></li>
							</ul>
						</div>
					</div>
				...
				<div class="copyright-section">
					<div class="row">
						<div class="col-md-6">
							<p>
								Copyright © 2016 OutGo Payment Solutions Pvt. Ltd &amp;
								Developed by &nbsp;<a href="https://www.outgo.co/index" target="_blank">www.outgo.co</a>
							</p>
						</div>
	...
	<div class="switcher-box"
		style="padding-left: 15px; padding-right: 15px; background-color: #eee;">
		<a class="open-switcher hidden-xs  show-switcher"
			style="font-family: sans-serif; font-size: medium; background-color: #00afd1; color: #fff; padding-top: 5px"><b>Enquiry</b></a>
		<h4 style="background-color: #00afd1">Send Enquiry</h4>
		<!-- <span>12 Predefined Color Skins</span> -->


		<div class="row"
			style="padding-left: 10px; padding-right: 10px; background-color: #eee">
			<div class="col-md-12">

				<span id="successMsgEq" style="display: none; color: green">Enquiry
					sent successfully</span> <span id="errorMsgEq"
					style="display: none; color: red">Enquiry sending error....</span>

				<form id="enq" action="" method="post">
					<div class="box-body">
						<div class="form-group">
							<div class="inner-addon left-addon">
								<input type="hidden" class="form-control" name="access_key"
									value="PrideTelecom65" /> <input type="hidden"
									class="form-control ref_id" name="ref_id" value="0" /> <input
									type="hidden" class="form-control" name="type" value="Enquiry" />

								<input type="tel" class="form-control sendenq-field mobile"
									name="customer_mobile" id="EnqMobile" placeholder="Mobile No."
									maxlength="10" data-toggle="EnqMobile"
									title="Please enter coorrect contact no"
									onkeypress="return isNumber(event)"
									onchange=searchComp(this.value) maxlength="10">
							</div>
						</div>
					...
					<div class="box-body">
						<div class="form-group">
							<div class="inner-addon left-addon">
								...
								<input type="text" class="form-control sendenq-field name"
									name="custName" id="EnqName" placeholder="Your Name"
									maxlength="30" data-toggle="EnqName"
						...
						<div class="form-group">
							<div class="inner-addon left-addon">
								...
								<input type="text" class="form-control"
									name="customer_email" id="Enqemail" placeholder="Your Email"
					...
					<div class="form-group">
						<div class="inner-addon left-addon">
							...
							<textarea rows="4" cols="4" class="form-control"
								name="msg_description" id="EnqDesc" placeholder="Description"
								maxlength="150" data-toggle="EnqDesc"
								title="Please fill out this field"></textarea>

						</div>
					</div>
					<div class="form-group">
						<button type="button" onclick="enquiry()" id="enqBtn"
							class="btn" style="background-color: #00afd1;color: #fff"
							data-loading-text="<i class='fa fa-spinner fa-spin '></i> Processing">Send
							Enquiry</button>
					</div>
